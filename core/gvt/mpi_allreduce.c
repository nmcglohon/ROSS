...
tw_gvt_step2(tw_pe *me)
{
	...
	// gvt_sig.causal_ordering_value = 0;
	...
	if (tw_event_sig_compare(me->GVT_sig, gvt_sig) > 0)
	{
		tw_error(TW_LOC, "PE %u GVT decreased %g -> %g",
				// me->id, me->GVT_sig.recv_ts, me->GVT_sig.event_tiebreaker, me->GVT_sig.causal_ordering_value, gvt_sig.recv_ts, gvt_sig.event_tiebreaker, gvt_sig.causal_ordering_value);
