...
static unsigned int tw_pq_compare_less_than_rand(tw_event *n, tw_event *e)
{
    ...
    else
    {
		...
		// if (tw_unique_event_id_eq(n->sig.causal_origin, e->sig.causal_origin)) //if they are in a zero-offset causal chain
		// if (event_is_causal_related(n->sig, e->sig))
		// {
		// 	if (n->sig.causal_ordering_value < e->sig.causal_ordering_value)
		// 		return 1;
		// 	else if (n->sig.causal_ordering_value > e->sig.causal_ordering_value)
		// 		return 0;
		// 	else {
		// 		if (n->event_id < e->event_id)
		// 			return 1;
		...
		// else
		// {
		// 	if (n->sig.event_tiebreaker < e->sig.event_tiebreaker)
		// 		return 1;
		// 	else if (n->sig.event_tiebreaker > e->sig.event_tiebreaker)
		// 		return 0;
		// 	else {
		// 		if (n->event_id < e->event_id)
		// 			return 1;
